$(function () {
	...
	$('.followers-feed__slider').slick({
		...
		variableWidth: true,
		speed: 1000,
		prevArrow: '<button class="arrow followers-feed__arrow-left"><img class="template__img-arrow-left" src="../images/icons/chevron-left.svg" alt=""></button>',
		nextArrow: '<button class="arrow followers-feed__arrow-right"><img class="template__img-arrow-right" src="../images/icons/chevron-right.svg" alt=""></button>'
	});
